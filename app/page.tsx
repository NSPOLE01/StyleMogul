    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <Link
            href="/upload"
            className="inline-block bg-primary-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-primary-600 transition-all hover:shadow-lg hover:scale-105"
          >
            Start Discovering
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="bg-white rounded-3xl p-8 shadow-soft hover:shadow-xl transition-shadow"
            >
